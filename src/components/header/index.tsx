    ...
    return(
        <header>
            <Popover className="relative bg-white  ">
                <div className="flex  fixed z-20 inset-x-0 bg-white/95 dark:bg-W3GTopBG/80 backdrop-blur-sm    transition duration-700 mb-10 pl-5 mb-5 justify-between items-center  p-4  sm:px-6 lg:justify-end md:space-x-10 lg:px-10  ">
                            ...
                            <div className="rounded-lg  shadow-lg ring-1 ring-black ring-opacity-5 bg-white dark:bg-black   transition duration-700 divide-y-2 divide-gray-50 dark:divide-neutral-700">
                                <div className="pt-5 pb-6 px-5">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="-mr-2">
                                            <Popover.Button className="bg- rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100  focus:ring-indigo-500">
                                            ...
                                            {({ open }) => (
                                                <>
                                                    <div className="relative">
                                                        ...
                                                        <div className="flex  ">
                                                            <Disclosure.Button  className='w-full py-2.5 text-sm leading-5  rounded-lg text-base font-medium text-black  dark:text-white flex outline-none'>
                                                                Blockchain
                                                                <ChevronDownIcon
                                                                    className={` w-5  `}
                                                                    aria-hidden="true"
                                                        ...
                                                        <Transition
                                                            ...
                                                            leaveTo="opacity-0 translate-y-1"
                                                        >
                                                            <Disclosure.Panel className="absolute border-t border-gray-400 bg-white dark:border-black dark:bg-neutral-700 w-40 shadow-2xl rounded-b-lg mt-3 p-2">
                                                                {blockchain.map(item=>(
                                                                    <a key={item.name} href={item.href} className="text-sm flex text-base hover:bg-gray-100 hover:text-black dark:hover:text-white dark:hover:bg-black rounded-md dark:border-gray-500 dark:text-gray-300  mb-2" >
                                                                        <div className="  w-48">
                                                                            <div className="p-2">
