                                        ...
                                        <Listbox.Options  className="origin-top-right absolute z-10 right-0 w-80  rounded-md shadow-lg overflow-hidden bg-gray-50  dark:bg-neutral-800 ">
                                            ...
                                            <div className="m-3 ">
                                                <div className="p-2">
                                                    ...
                                                    <input type="text"
                                                           className="mt-2 bg-gray-200 dark:bg-neutral-800 dark:placeholder-neutral-500 dark:text-gray-300  text-xs md:text-sm w-full  rounded-lg p-1.5 border dark:border-neutral-600 dark:text-white  focus:border-black dark:focus:border-gray-200 focus:bg-white dark:bg-gray-300  outline-none"
